                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            ...
                            <p className="font-medium text-smart-green">{cropDetails[2]}</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="text-gray-500 text-sm">Quantity</p>
                            <p className="font-medium text-smart-green">{cropDetails[3].toString()}</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="text-gray-500 text-sm">Price (wei)</p>
                            <p className="font-medium text-smart-green">{cropDetails[4].toString()}</p>
                          </div>
                          <div className="bg-white p-3 rounded-md shadow-sm">
                            <p className="text-gray-500 text-sm">Seller</p>
                            <p className="font-medium text-smart-green truncate">{cropDetails[1]}</p>
                          </div>
                        </div>
