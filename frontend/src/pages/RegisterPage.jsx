...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12 pt-20">
        ...
        <div className={`bg-white rounded-lg shadow-xl overflow-hidden transform transition-all duration-500 ${isAnimating ? 'scale-95 opacity-80' : 'scale-100'}`}>
          ...
          <div className="bg-smart-green p-6 text-center">
            <div className="flex justify-center mb-3">
              <div className="bg-smart-yellow/30 rounded-full p-3 shadow-lg border border-smart-yellow/50">
                <UserPlus size={30} className="text-smart-yellow" />
              </div>
            </div>
          ...
          <div className={`p-6 space-y-6 ${step === 3 ? 'text-center' : ''}`}>
            ...
            {step === 3 && (
              <div className="flex flex-col items-center py-8">
                ...
                <p className="text-gray-500 mb-8">Welcome to SmartCropX, <span className="font-medium">{formData.fullName}</span>!</p>
                <button
                  onClick={() => navigate('/')}
