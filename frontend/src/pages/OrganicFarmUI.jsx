...
const OrganicFarmUI = () => {
  ...
  return (
    <div id="aboutus" className="bg-gradient-to-b from-smart-green to-green-900 min-h-screen w-full p-4 md:p-8 flex items-center justify-center overflow-hidden">
