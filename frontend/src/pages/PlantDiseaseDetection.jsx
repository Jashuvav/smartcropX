...
const PlantDiseaseDetection = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-smart-green to-green-900 p-6 pt-24 overflow-hidden">
                ...
                {detectionResult.error ? (
                  ...
                  <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      <div className="w-full max-w-md sm:max-w-none bg-black bg-opacity-30 p-3 rounded-lg mx-auto sm:mx-0">
                        <p className="text-gray-400 text-sm">Disease</p>
                        <p
                          className="text-xl font-bold break-words whitespace-normal text-center sm:text-left leading-snug"
                          style={{
                        ...
                        >
                          {formatDiseaseName(detectionResult.disease)}
                        </p>
                      </div>
                      
                      <div className="w-full max-w-md sm:max-w-none bg-black bg-opacity-30 p-3 rounded-lg mx-auto sm:mx-0">
                        <p className="text-gray-400 text-sm">Confidence</p>
                        <p className="text-xl font-bold text-center sm:text-left">{(detectionResult.confidence * 100).toFixed(1)}%</p>
                      </div>
                    </div>

                    <div className="mt-4 w-full max-w-md sm:max-w-none bg-black bg-opacity-30 p-3 rounded-lg mx-auto sm:mx-0">
                      <p className="text-gray-400 text-sm mb-1">Why this disease?</p>
                      <p className="break-words whitespace-normal leading-relaxed">{detectionResult.why}</p>
                    </div>
                  </div>
                )}
              </div>
